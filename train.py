...
if __name__ == '__main__':
    ...
    model = BertPunc(model_name, model_size, args=args)
    ...
    if task in ['all']:
        train_ids, train_token_ids, train_lens, train_mask, train_label_a, train_label_b = all_tasks(TRAIN_PATH, tokenizer=tokenizer, truncate=truncate)
        dev_ids, dev_token_ids, dev_lens, dev_mask, dev_label_a, dev_label_b = read_test_file_all(tokenizer)
        test_ids, test_token_ids, test_lens, test_mask, test_label_a, test_label_b = read_test_file_all(tokenizer)
        train_labels = {'a': train_label_a, 'b': train_label_b}
        dev_labels = {'a': dev_label_a, 'b': dev_label_b}
    ...
    dataloaders = {
        ...
        'dev': DataLoader(dataset=datasets['dev'], batch_size=bs)
        ,
